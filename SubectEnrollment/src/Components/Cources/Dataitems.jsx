    ...
    <div>
      <section className="relative w-full  border-2 p-0 m-0 mx-auto my-5  shadow-2xl shadow-gray-700 rounded-xl  overflow-hidden">
        <NavLink reloadDocument to={`/${props.Name}/${props.Name}`}>
          ...
          <div>
            <img
              className=" object-fill  aspect-[16/11] w-full "
              src={props.img}
              alt=""
            />
          </div>
        ...
        <div className="flex flex-col justify-center items-center  text-black lg:h-40">
          <div className="text-2xl  font-bold text-center py-2 underline">
            {props.desc}
          </div>
          <div className="px-4 mx-auto text-md font-medium  py-2 text-center ">
            {props.content}
          </div>
        ...
        <NavLink reloadDocument to={`/${props.Name}/${props.Name}`}>
          <div
            className='w-full py-2 text-black bg-[#fad902] text-center text-xl font-bold cursor-pointer  text-[1.25rem]  
